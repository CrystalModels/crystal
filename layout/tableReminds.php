...
$headerslink=$_SESSION['ranCode']." ".$_SESSION['key'];
 ...
 async function getReminds() {
  ...
  .then(data => {
    ...
    <td>${remnind.rDate}</td>
    <td>${remnind.rTime}</td>
    <td><input type="text" class="input-schedule" id="${remnind.remindId}" value="${remnind.remindId}"> <button onclick="editarAlerta(this,&quot;${remnind.alertId}&quot;,&quot;${remnind.profileId}&quot;)">Responder</button></td>
...
function editarAlerta(button, id,profileid) {
  ...
  var url = 'controller/controllerEditMyRemind.php?alertId=' + encodeURIComponent(id) + '&response=' + encodeURIComponent(response)+ '&profileId=' + encodeURIComponent(profileid);
