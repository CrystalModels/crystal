 ...
 async function getPagesAssignModels() {
  ...
  .then(data => {
    ...
    data.pages.forEach(student => {
      ...
      row.innerHTML = `
      <td><button onclick="desconectarTransmision(this,&quot;${student.pageId}&quot;,&quot;${student.modelId}&quot;,&quot;${student.transId}&quot;);" class="table-button">Desconectar transmisión</button></td>
 ...
 async function getPagesAssignModels1() {
  ...
  .then(data => {
    ...
    data.pages.forEach(student => {
      const row = document.createElement("tr");
      row.innerHTML = `
      <td><button onclick="desconectarTransmisionModel(this,&quot;${student.pageId}&quot;,&quot;${student.modelId}&quot;,&quot;${student.transId}&quot;);getPagesAssignModels1();" class="table-button">Parar transmisión</button></td>
