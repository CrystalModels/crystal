 ...
 async function getPagesAssignModelsHis11(modelid,datetime) {
  ...
  .then(data => {
    ...
    data.earns.forEach(student => {
      ...
      <td>${student.time}</td>
      <td><button onclick="enviarCorreo(&quot;${student.modelId}&quot;,&quot;El corte ID ${student.cuttingId} fue cerrado con un valor inicial de $${student.start}, un total de descuentos $${student.discount} y un porcentaje de descuentos del (${student.percent}%), para un total de $${student.end} por recibir. Un promedio de tiempo trabajado de (${student.time}).&quot;,&quot;Cierre de corte&quot;)" class="table-button">Enviar correo</button></td>
