  ...
  .then(data => {
    ...
    data.pages.forEach(student => {
      ...
      <td>${student.pageName}</td>
        ...
        <td><input type="text" id="pageKey" name="pagekey" placeholder="Ingresa contraseña" value="${student.pageLink}"><button onclick="editarCredenciales(this,&quot;${student.pageId}&quot;,&quot;${student.modelId}&quot;,&quot;${student.transId}&quot;,&quot;pLink&quot;);" class="table-button">Editar</button><a href="https://www.ejemplo.com/ruta-completa/${student.pageLink}" target="_blank">Acceso directo</a>
        </td>
